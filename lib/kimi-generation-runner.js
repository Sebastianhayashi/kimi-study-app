...
const PROGRESS_TOOL = {
  ...
  description: 'Report a real, learner-facing course generation phase. Call at the start or completion of each major phase. Never include private reasoning, answers, grading keys, shell commands, or internal paths.',
  parameters: {
    type: 'object',
    properties: {
      phase: {
        type: 'string',
        enum: ['extracting', 'profiling', 'claims', 'blueprint', 'questions', 'quality', 'assembling', 'validating', 'complete'],
      },
