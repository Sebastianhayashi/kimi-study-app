...
function createSkillBundleMaterializer({ bundleStore } = {}) {
  if (!bundleStore || typeof bundleStore.get !== 'function' || typeof bundleStore.setInstallationState !== 'function') {
  ...
  function importFromDirectory(bundleId, { sourceRoot } = {}) {
    ...
    if (sourceDigest !== manifest.rootDigest) {
    ...
    try {
      ...
      if (stagedDigest !== manifest.rootDigest) {
