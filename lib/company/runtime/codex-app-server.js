...
function assertThreadMatchesAdmission(threadResult, profile) {
  ...
  if (!Object.prototype.hasOwnProperty.call(threadResult, 'serviceTier') || threadResult.serviceTier !== null) {
...
function createCodexAppServerRuntime({ spawnImpl = spawn, authorityBoundary = null, admission = null } = {}) {
