...
function createSkillCatalog({ bundleStore } = {}) {
  ...
  function get(id) {
    ...
    return entry ? { ...entry, triggers: [...entry.triggers], allowedTools: [...entry.allowedTools] } : null;
  }

  function list() {
    return [...entries.values()]
      .map((entry) => ({ ...entry, triggers: [...entry.triggers], allowedTools: [...entry.allowedTools] }))
  ...
  function load(id) {
    ...
    return { ...entry, triggers: [...entry.triggers], allowedTools: [...entry.allowedTools], body };
  }
