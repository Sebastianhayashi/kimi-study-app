...
function buildNextLessonPrompt(courseDir, baseline, { validatorCommand = '', resumedSession = false } = {}) {
  ...
  return [
    ...
    'Activity 2 是 transfer 阶段的 short-answer：提供一个未在正文直接出现的新情境，要求学习者应用本课能力并解释理由；minimumLength 至少 40。',
    '结构必须遵守下面形状：',
    '{',
    '  "schemaVersion": 1,',
    '  "lessonId": "LESSON_BASE",',
    '  "title": "本课标题",',
    '  "claims": [{"id":"claim-1","label":"可观察能力","sourceRefs":["source:book#真实位置"],"mastery":{"requiredPassed":2,"requiredStages":["independent","transfer"]}}],',
    '  "activities": [',
    ...
    '    {"id":"transfer-1","type":"short-answer","claimId":"claim-1","stage":"transfer","prompt":"在新情境中应用并解释理由","scoring":{"mode":"completion","minimumLength":40},"sourceRefs":["source:book#真实位置"],"feedback":{"correct":"给出自查标准","incorrect":"要求补充证据和理由"},"hints":[{"content":"提示使用本课原则，但不替用户作答"}]}',
    '  ]',
    '}',
